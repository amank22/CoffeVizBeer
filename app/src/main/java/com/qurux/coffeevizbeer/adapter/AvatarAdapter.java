...
public class AvatarAdapter extends RecyclerView.Adapter<AvatarAdapter.ViewHolder> {
    ...
    private int[] avatars = {
            ...
            R.drawable.ic_avatar9, R.drawable.ic_avatar10, R.drawable.ic_avatar11, R.drawable.ic_avatar12,
            R.drawable.ic_avatar13, R.drawable.ic_avatar14, R.drawable.ic_avatar15, R.drawable.ic_avatar16,
